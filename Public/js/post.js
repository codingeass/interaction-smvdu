function listpost(){
		...
		{
			mk=mk+"<section style='border:1px solid black;border-radius:3px;padding:15px;margin:50px;'><h2><a href='blog.html?t="+x[i].getElementsByTagName("time")[0].childNodes[0].nodeValue+"&em="+x[i].getElementsByTagName("email")[0].childNodes[0].nodeValue+"' target='_blank'>"+x[i].getElementsByTagName("title")[0].childNodes[0].nodeValue+"</a></h2>";
